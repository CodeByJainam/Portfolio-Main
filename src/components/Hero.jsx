...
const Hero = () => {
  ...
  const typedItems = ["Web Developer", "Front-End-Developer"];
    ...
    const typeItem = () => {
      if (charIndex < typedItems[itemIndex].length) {
        ...
        setTimeout(() => {
          ...
          setCharIndex(0);
          setTypedText("");
        }, 250); // Delay before typing the next item
      }
    };

    const typingInterval = setInterval(typeItem, 150); // Typing speed
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915EFF]">Jainam</span>
          </h1>
